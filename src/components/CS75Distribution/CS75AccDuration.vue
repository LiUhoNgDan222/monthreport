  ...
  export default {
    ...
    data() {
      return {
        ...
        barNum: [1.84, 10.18,8.95,9.4,],
        barNum1: [403, 306,482,494.8,],
        lineNum: [0.46, 3.33,1.86,1.9,],
        barNum2: [0.009, 0.017,0.012,0.014,],
        barNum3: [2.14, 1.27,2.14,2.19,],
        lineNum1: [0.42, 1.36,0.58,0.65,],
      }
    },
    mounted(){
